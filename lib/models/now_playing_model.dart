...
class NowPlayingModel {
    ...
    factory NowPlayingModel.fromJson(Map<String, dynamic> json) => NowPlayingModel(
        ...
        page: json["page"],
        results: List<ResultNowPlaying>.from(json["results"].map((x) => ResultNowPlaying.fromJson(x))),
...
class ResultNowPlaying {
    ...
    factory ResultNowPlaying.fromJson(Map<String, dynamic> json) => ResultNowPlaying(
        adult: json["adult"],
