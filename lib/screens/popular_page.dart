...
class PopularPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<PopularProvider>(context);
    return Scaffold(
      body: SafeArea(
                ...
                children: [
                 Padding(
                   ...
                   child: Row(
                    ...
                    Text("Popular Movie",style: primaryTextStyle.copyWith(fontWeight: bold,fontSize: 20),),
                     ],
                   ),
                 ),
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ResultPopular data = provider.list[index];
