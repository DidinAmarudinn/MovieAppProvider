...
class TopRatedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<TopRatedProvider>(context);
    return Scaffold(
      body: SafeArea(
                ...
                children: [
                 Padding(
                   ...
                   child: Row(
                    ...
                    Text("Top Rated",style: primaryTextStyle.copyWith(fontWeight: bold,fontSize: 20),),
                     ],
                   ),
                 ),
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ResultTopRated data = provider.list[index];
